package com.audacix.base.utils.string;
 ...
 * @author Javi
 */
public class StringUtils extends Utility {
     ...
     */
    public String listToEnglishCompound(Collection<String> list) {
     ...
     */
    public String listToEnglishCompound(Collection<?> list, String prefix, String suffix) {
